...
class AdminSmsContactController extends Controller
{
    /**
     * Display list of admin contacts
     */
    public function index(Request $request)
    {
        $admin = Auth::guard('admin')->user();

        $query = SmsContact::where('owner_id', $admin->id)
        ...
        return view('admin.sms-contacts.index', compact('contacts', 'groups', 'groupsCount'));
    }
    ...
    {
        return view('admin.sms-contacts.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Check for duplicate
        $exists = SmsContact::where('owner_id', $admin->id)
            ->where('owner_type', get_class($admin))
        ...
        return redirect()->route('admin.sms-contacts.index')
    ...
    {
        return view('admin.sms-contacts.bulk-upload');
    }
    ...
    public function bulkStore(Request $request)
    {
        ...
        try {
            ...
            // Get existing phone numbers for this admin
            $existingNumbers = SmsContact::where('owner_id', $admin->id)
                ->where('owner_type', get_class($admin))
                ->pluck('phone_number')
                ->toArray();
    ...
    public function destroy($id)
    {
        ...
        $contact = SmsContact::where('owner_id', $admin->id)
            ->where('owner_type', get_class($admin))
            ->findOrFail($id);
