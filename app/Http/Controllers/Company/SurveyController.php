...
class SurveyController extends Controller
{
    ...
    {
        $query = auth()->guard('company')->user()->surveys();
        ...
        $stats = [
            'total_surveys' => auth()->guard('company')->user()->surveys()->count(),
            'active_surveys' => auth()->guard('company')->user()->surveys()->where('status', 'active')->count(),
            'total_responses' => auth()->guard('company')->user()->surveys()->sum('responses_count'),
            'avg_completion_rate' => round(auth()->guard('company')->user()->surveys()->avg('completion_rate'), 1),
        ];

        return view('company.surveys.index', compact('surveys', 'stats'));
    }
    ...
    public function create()
    {
        ...
        return view('company.surveys.create', compact('templates'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // If a template was selected, create default questions
        if ($request->filled('template')) {
            $this->createTemplateQuestions($survey, $request->template);
        }

        return redirect()->route('organization.surveys.builder.index', $survey)
    ...
    public function show(Survey $survey)
    {
        ...
        return view('company.surveys.show', compact('survey', 'stats'));
    }
    ...
    public function edit(Survey $survey)
    {
        ...
        return view('company.surveys.edit', compact('survey'));
    }
    ...
    public function update(Request $request, Survey $survey)
    {
        ...
        return redirect()->route('organization.surveys.show', $survey)
    ...
    public function duplicate(Survey $survey)
    {
        ...
        return redirect()->route('organization.surveys.show', $newSurvey)
