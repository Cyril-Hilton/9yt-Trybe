...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('ui/logo/9yt-trybe-logo-light.png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/glassmorphism.css')); ?>?v=<?php echo e(time()); ?>">
    <style>
...
<body class="bg-white dark:bg-black min-h-screen transition-colors duration-300" x-data="{ mobileMenuOpen: false }">
    ...
    <?php echo $__env->make('components.logo-loader', ['id' => 'page-loader', 'text' => 'Loading the !Trybe Community...'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <nav class="sticky top-0 z-50 glass-header-transparent shadow-lg transition-all duration-300">
            ...
            <div class="flex justify-between items-center h-16 sm:h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="/" class="flex items-center logo-hover">
                        <img x-show="!darkMode" src="<?php echo e(asset('ui/logo/9yt-trybe-logo-light.png')); ?>" alt="9yt !Trybe" class="h-10 sm:h-12 md:h-14 w-auto">
                        <img x-show="darkMode" x-cloak src="<?php echo e(asset('ui/logo/9yt-trybe-logo-dark.png')); ?>" alt="9yt !Trybe" class="h-10 sm:h-12 md:h-14 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-6 lg:space-x-8 flex-1 justify-center ml-8 lg:ml-12">
                    <a href="<?php echo e(route('events.index')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Events</a>
                    <a href="<?php echo e(route('shop.index')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Shop</a>
                    <a href="<?php echo e(route('gallery.index')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Gallery</a>
                    <a href="<?php echo e(Auth::guard('company')->check() ? route('organization.sms.dashboard') : route('user.sms.dashboard')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Bulk SMS</a>
                    <a href="<?php echo e(route('jobs.index')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Jobs</a>
                    <a href="<?php echo e(route('team.index')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Team</a>
                    <a href="<?php echo e(route('about')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">About</a>
                    <a href="<?php echo e(route('contact')); ?>" class="relative px-3 py-2 text-white font-semibold transition-all duration-300 rounded-lg whitespace-nowrap hover:bg-white/20 hover:backdrop-blur-lg">Contact</a>
                </div>
                ...
                <div class="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 md:gap-4">
                        ...
                        <div x-data="{ searchOpen: false, query: '', suggestions: [], loading: false, error: '' }" class="relative">
                            ...
                            <div x-show="searchOpen" @click.away="searchOpen = false" x-cloak
                                ...
                                <form action="<?php echo e(route('search')); ?>" method="GET" @submit.prevent="if(query) window.location.href = '<?php echo e(route('search')); ?>?q=' + query">
                                    <div class="relative">
                                        <input
                                            x-ref="searchInput"
                                            type="text"
                        ...
                        <a href="<?php echo e(route('shop.cart')); ?>" class="hidden sm:block relative text-white hover:text-cyan-300 transition">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center gap-1 sm:gap-2 text-white hover:text-cyan-300 font-medium transition whitespace-nowrap">
                                ...
                                <span class="hidden lg:inline truncate max-w-[120px]"><?php echo e(auth()->user()->name); ?></span>
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak
                                ...
                                <div class="px-4 py-3 border-b border-white/20 dark:border-gray-700/50">
                                    ...
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1"><?php echo e(auth()->user()->email); ?></p>
                                </div>
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                    </svg>
                                    Dashboard
                                </a>
                                <a href="<?php echo e(route('user.tickets')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('switch.to.organizer')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-indigo-600 dark:text-indigo-400 font-medium bg-indigo-50/30 dark:bg-indigo-900/20 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-all border border-indigo-200/30 dark:border-indigo-800/30">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 md:gap-4">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center gap-1 sm:gap-2 text-white hover:text-cyan-300 font-medium transition whitespace-nowrap">
                                ...
                                <span class="hidden lg:inline truncate max-w-[120px]"><?php echo e(auth('company')->user()->name); ?></span>
                                <svg class="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </button>
                            <div x-show="open" @click.away="open = false" x-cloak
                                 class="absolute right-0 mt-2 w-64 glass-dropdown rounded-xl py-2 z-50 shadow-2xl">
                                <div class="px-4 py-3 border-b border-white/20 dark:border-gray-700/50">
                                    <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(auth('company')->user()->name); ?></p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1"><?php echo e(auth('company')->user()->email); ?></p>
                                </div>
                                <a href="<?php echo e(route('organization.dashboard')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                    </svg>
                                    Dashboard
                                </a>
                                <a href="<?php echo e(route('organization.events.index')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    My Events
                                </a>
                                <a href="<?php echo e(route('organization.events.create')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                    </svg>
                                    Create Event
                                </a>
                                <a href="<?php echo e(route('organization.profile.edit')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-lg transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('switch.to.user')); ?>" class="block mx-2 my-1 px-3 py-2 text-sm text-indigo-600 dark:text-indigo-400 font-medium bg-indigo-50/30 dark:bg-indigo-900/20 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-all border border-indigo-200/30 dark:border-indigo-800/30">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                    </svg>
                                    Switch to User
                                ...
                                <hr class="my-2 border-white/20 dark:border-gray-700/50">
                                <form method="POST" action="<?php echo e(route('organization.logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="block w-full mx-2 my-1 px-3 py-2 text-left text-sm text-red-600 dark:text-red-400 font-medium bg-red-50/30 dark:bg-red-900/20 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-all border border-red-200/30 dark:border-red-800/30">
                                        <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/>
                    ...
                    <div class="hidden md:flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                        ...
                        <!-- Cart Icon -->
                        <a href="<?php echo e(route('shop.cart')); ?>" class="relative text-white hover:text-cyan-300 transition">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                            </svg>
                        </a>

                        <a href="<?php echo e(route('user.login')); ?>" class="px-4 py-2 text-white hover:text-cyan-300 font-medium transition whitespace-nowrap flex-shrink-0">Login</a>
                        <a href="<?php echo e(route('user.register')); ?>" class="glass-btn px-6 py-2 rounded-lg font-semibold transition-all shadow-lg whitespace-nowrap flex-shrink-0" style="white-space: nowrap !important;">Sign&nbsp;Up</a>
                    </div>
                    <?php endif; ?>
                    <?php endif; ?>
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="px-4 py-3 space-y-2">
                <a href="<?php echo e(route('events.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Events</a>
                <a href="<?php echo e(route('shop.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Shop</a>
                <a href="<?php echo e(route('gallery.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Gallery</a>
                <a href="<?php echo e(Auth::guard('company')->check() ? route('organization.sms.dashboard') : route('user.sms.dashboard')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Bulk SMS</a>
                <a href="<?php echo e(route('jobs.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Jobs</a>
                <a href="<?php echo e(route('team.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Team</a>
                <a href="<?php echo e(route('about')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">About</a>
                <a href="<?php echo e(route('contact')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Contact</a>
                <?php if(auth()->guard()->check()): ?>
                <div class="border-t border-white/30 dark:border-gray-700/50 pt-2 mt-2">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Dashboard</a>
                    <a href="<?php echo e(route('user.tickets')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">My Tickets</a>
                    <form method="POST" action="<?php echo e(route('user.logout')); ?>" class="mt-4">
                        <?php echo csrf_field(); ?>
                ...
                <?php if(auth()->guard('company')->check()): ?>
                <div class="border-t border-white/30 dark:border-gray-700/50 pt-2 mt-2">
                    <a href="<?php echo e(route('organization.dashboard')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Dashboard</a>
                    <a href="<?php echo e(route('organization.events.index')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">My Events</a>
                    <form method="POST" action="<?php echo e(route('organization.logout')); ?>" class="mt-4">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="block w-full text-left px-4 py-2 text-red-600 dark:text-red-400 font-medium bg-red-50/30 dark:bg-red-900/20 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-xl transition-all border border-red-200/30 dark:border-red-800/30">Logout</button>
                    </form>
                </div>
                <?php else: ?>
                <div class="border-t border-white/30 dark:border-gray-700/50 pt-2 mt-2">
                    <a href="<?php echo e(route('user.login')); ?>" class="block px-4 py-2 text-gray-900 dark:text-white font-medium bg-white/30 dark:bg-gray-800/40 hover:bg-white/50 dark:hover:bg-gray-800/70 rounded-xl transition-all border border-white/30 dark:border-gray-700/40 shadow-lg">Login</a>
                    <a href="<?php echo e(route('user.register')); ?>" class="glass-btn block px-4 py-2 mt-2 rounded-xl font-semibold text-center transition-all">Sign&nbsp;Up</a>
                </div>
                <?php endif; ?>
                <?php endif; ?>
            </div>
        ...
        <div class="relative h-[300px] md:h-[400px] lg:h-[500px] overflow-hidden neon-border rounded-b-3xl">
            ...
            <div x-show="currentSlide === 0"
                ...
                <video autoplay muted loop playsinline class="w-full h-full object-cover">
                    <source src="<?php echo e(asset('ui/sliders/slide1.mp4')); ?>" type="video/mp4">
            ...
            <div x-show="currentSlide === 1"
                 ...
                 class="absolute inset-0">
                <video autoplay muted loop playsinline class="w-full h-full object-cover">
                    <source src="<?php echo e(asset('ui/sliders/slide2.mp4')); ?>" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
    ...
    <section class="bg-gradient-to-br from-gray-50 via-slate-50/30 to-pink-50/30 dark:from-gray-900 dark:via-slate-900/10 dark:to-slate-800/10 transition-colors duration-300">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(now()->format('M j, Y • g:i A')); ?></p>
                <?php endif; ?>
            </div>

            <!-- Filters -->
            <div class="flex items-center space-x-4 border-b-2 border-cyan-200 dark:border-cyan-800">
                <a href="/<?php echo e(request('region') ? '?region='.request('region') : ''); ?>" class="pb-3 px-4 <?php echo e(!request('filter') ? 'border-b-4 border-gradient-to-r from-cyan-600 to-cyan-500 text-cyan-600 dark:text-cyan-400 font-bold neon-glow' : 'text-gray-600 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:border-b-2 hover:border-cyan-400'); ?> transition-all duration-300">All</a>
                <a href="/?filter=today<?php echo e(request('region') ? '&region='.request('region') : ''); ?>" class="pb-3 px-4 <?php echo e(request('filter') == 'today' ? 'border-b-4 border-gradient-to-r from-cyan-600 to-cyan-500 text-cyan-600 dark:text-cyan-400 font-bold neon-glow' : 'text-gray-600 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:border-b-2 hover:border-cyan-400'); ?> transition-all duration-300">Today</a>
                <a href="/?filter=this_weekend<?php echo e(request('region') ? '&region='.request('region') : ''); ?>" class="pb-3 px-4 <?php echo e(request('filter') == 'this_weekend' ? 'border-b-4 border-gradient-to-r from-cyan-600 to-cyan-500 text-cyan-600 dark:text-cyan-400 font-bold neon-glow' : 'text-gray-600 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 hover:border-b-2 hover:border-cyan-400'); ?> transition-all duration-300">This weekend</a>
            </div>
            ...
            <div class="mt-6 sm:mt-8">
                ...
                <div class="overflow-x-auto pb-2 -mx-4 sm:mx-0 sm:overflow-visible scrollbar-hide">
                    <div class="flex sm:grid sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-11 gap-3 sm:gap-4 min-w-max sm:min-w-0 px-4 sm:px-0 after:content-[''] after:block after:w-4 after:flex-shrink-0 sm:after:hidden">
                            ...
                            <a href="<?php echo e(route('categories.show', $category->slug)); ?>"
                               class="group flex-shrink-0">
                                ...
                                <div class="flex flex-col items-center w-[72px] sm:w-full p-2.5 sm:p-3 rounded-xl glass-card hover-lift transition-all duration-300 group-hover:scale-105">
                                    <!-- Icon Container -->
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-<?php echo e($category->color); ?>-400/20 to-<?php echo e($category->color); ?>-600/30 dark:from-<?php echo e($category->color); ?>-500/30 dark:to-<?php echo e($category->color); ?>-700/40 flex items-center justify-center mb-2 group-hover:shadow-lg group-hover:shadow-<?php echo e($category->color); ?>-500/50 transition-all duration-300" style="backdrop-filter: blur(20px) saturate(180%);">
                                        <div class="text-<?php echo e($category->color); ?>-600 dark:text-<?php echo e($category->color); ?>-400 w-5 h-5 sm:w-6 sm:h-6">
                                            <?php echo $category->getIconHtml(); ?>

                                        </div>
                                    </div>
                                    <!-- Category Name -->
                                    <span class="text-[10px] sm:text-xs font-semibold text-gray-800 dark:text-gray-200 text-center leading-tight group-hover:text-<?php echo e($category->color); ?>-600 dark:group-hover:text-<?php echo e($category->color); ?>-400 transition-colors whitespace-nowrap">
                        ...
                        <!-- "View All" Button -->
                        <a href="<?php echo e(route('events.index')); ?>" class="group flex-shrink-0">
                            <div class="flex flex-col items-center w-[72px] sm:w-full p-2.5 sm:p-3 rounded-xl glass-card hover-lift transition-all duration-300 group-hover:scale-105">
            ...
            <a href="<?php echo e(route('events.show', $event->slug)); ?>" class="group">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden card-glow hover-lift border-2 border-transparent hover:border-cyan-500 transition-all duration-300">
                    ...
                    <div class="relative bg-gradient-to-br from-indigo-500 to-blue-600 overflow-hidden">
                        ...
                        <img src="<?php echo e($event->banner_url); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-auto">
                        <?php else: ?>
                    ...
                    <div class="p-4">
                        ...
                        <div class="text-xs font-semibold text-cyan-600 dark:text-cyan-400 uppercase mb-2">
                            <?php echo e($event->start_date->format('D, M j, g:i A')); ?>
                        ...
                        <div class="flex items-start text-sm text-gray-600 dark:text-gray-400 mb-3">
                            <?php if($event->location_type === 'venue'): ?>
                                <svg class="w-4 h-4 mr-1 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                </svg>
                                <span class="line-clamp-2"><?php echo e($event->venue_name ?? 'Venue'); ?></span>
                        ...
                        <div class="text-sm font-semibold">
                            <?php if($event->hasFreeTickets()): ?>
                                <span class="text-green-600 dark:text-green-400">Free</span>
                            <?php elseif($event->cheapest_ticket_price > 0): ?>
                                <span class="text-gray-900 dark:text-white">From GH₵<?php echo e(number_format($event->cheapest_ticket_price, 2)); ?></span>
                            <?php else: ?>
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('events.index')); ?>" class="inline-block px-8 py-4 bg-gradient-to-r from-cyan-600 via-cyan-500 to-blue-600 hover:from-cyan-700 hover:via-cyan-600 hover:to-indigo-700 text-white text-lg font-bold rounded-xl shadow-lg hover-lift pulse-button transition-all duration-300">
                View All Events
            </a>
        </div>
        <?php endif; ?>
    ...
    <section class="py-10 sm:py-14 lg:py-16 bg-white dark:bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <a href="<?php echo e(route('news.index')); ?>" class="inline-flex items-center gap-2 text-cyan-600 dark:text-cyan-400 font-semibold hover:text-cyan-700 dark:hover:text-cyan-300 transition">
                    View all news
            ...
            <?php if(!empty($newsArticles)): ?>
                <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = array_slice($newsArticles, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition">
                            <?php if(!empty($article['image'])): ?>
                                <a href="<?php echo e($article['url']); ?>" target="_blank" rel="noopener">
                                    <img src="<?php echo e($article['image']); ?>" alt="<?php echo e($article['title']); ?>" class="w-full h-44 object-cover">
                                </a>
                            <?php endif; ?>
                            <div class="p-5">
                                ...
                                <h3 class="mt-2 text-lg font-bold text-gray-900 dark:text-white">
                                    <a href="<?php echo e($article['url']); ?>" target="_blank" rel="noopener" class="hover:text-cyan-600 dark:hover:text-cyan-400">
                                ...
                                <div class="mt-4 text-xs text-gray-500 flex items-center justify-between">
                                    <span><?php echo e($article['author'] ?? 'Editorial'); ?></span>
                                    <span>
                                        <?php echo e(!empty($article['published_at']) ? \Carbon\Carbon::parse($article['published_at'])->format('M d, Y') : ''); ?>
    ...
    <footer class="bg-gray-900 dark:bg-gray-950 text-white mt-16 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('events.index')); ?>" class="text-gray-400 hover:text-white transition">Events</a></li>
                        <li><a href="<?php echo e(route('shop.index')); ?>" class="text-gray-400 hover:text-white transition">Shop</a></li>
                        <li><a href="<?php echo e(route('gallery.index')); ?>" class="text-gray-400 hover:text-white transition">Gallery</a></li>
                        <li><a href="<?php echo e(Auth::guard('company')->check() ? route('organization.sms.dashboard') : route('user.sms.dashboard')); ?>" class="text-gray-400 hover:text-white transition">Bulk SMS</a></li>
                        <li><a href="<?php echo e(route('jobs.index')); ?>" class="text-gray-400 hover:text-white transition">Jobs</a></li>
                        <li><a href="<?php echo e(route('team.index')); ?>" class="text-gray-400 hover:text-white transition">Join Team</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('legal.terms')); ?>" class="text-gray-400 hover:text-white transition">Terms & Conditions</a></li>
                        <li><a href="<?php echo e(route('legal.privacy')); ?>" class="text-gray-400 hover:text-white transition">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('legal.cookies')); ?>" class="text-gray-400 hover:text-white transition">Cookie Policy</a></li>
                        <li><a href="<?php echo e(route('legal.refund')); ?>" class="text-gray-400 hover:text-white transition">Refund Policy</a></li>
                        <li><a href="<?php echo e(route('legal.disclaimer')); ?>" class="text-gray-400 hover:text-white transition">Disclaimer</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> 9yt !Trybe. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function exploreNearMe() {
            return {
                ...
                preferredRegion: '<?php echo e(request('region')); ?>',
                ...
                async updateLocation(position) {
                    ...
                    try {
                        const provider = "<?php echo e(config('services.maps.provider', 'osm')); ?>";
                        if (provider === 'google') {
                            const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${this.userLat},${this.userLng}&key=<?php echo e(config('services.google.maps_api_key')); ?>`);
                            const data = await response.json();
