...
@section('title', 'Add Magazine Image')

@section('content')
<div class="p-8 max-w-3xl mx-auto">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Add Magazine Image</h1>
        <p class="text-gray-400">Upload a new magazine image</p>
    </div>
    ...
    <form action="{{ route('admin.magazine.store') }}" method="POST" enctype="multipart/form-data" class="bg-gray-800 rounded-xl p-6 border border-gray-700">
        @csrf
