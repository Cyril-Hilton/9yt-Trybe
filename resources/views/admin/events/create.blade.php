...
@section('title', 'Create External Event')
...
<div class="p-8">
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Create External Event</h1>
                <p class="text-gray-400">Add events from external organizers to promote on the platform</p>
            </div>
    ...
    <div class="bg-gray-800 rounded-xl p-6 border border-gray-700" x-data="{ isExternal: false, locationType: 'venue' }">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="summary" id="summary" rows="3" required maxlength="500"
                                  class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                  placeholder="Brief description of the event">{{ old('summary') }}</textarea>
                        @error('summary')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="overview" id="overview" rows="6"
                                  class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                  placeholder="Detailed description about the event">{{ old('overview') }}</textarea>
                        @error('overview')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="timezone" id="timezone" value="{{ old('timezone', 'Africa/Accra') }}"
                               class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        @error('timezone')
                            <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <label class="flex items-center p-4 bg-gray-700 border-2 border-gray-600 rounded-lg cursor-pointer hover:bg-gray-650 transition"
                                ...
                                <input type="radio" name="location_type" value="venue" x-model="locationType" required class="mr-3">
                                <span class="text-white">Physical Venue</span>
                            </label>
                            <label class="flex items-center p-4 bg-gray-700 border-2 border-gray-600 rounded-lg cursor-pointer hover:bg-gray-650 transition"
                                   :class="locationType === 'online' ? 'border-blue-500 bg-gray-650' : ''">
                                <input type="radio" name="location_type" value="online" x-model="locationType" required class="mr-3">
                                <span class="text-white">Online</span>
                            </label>
                            <label class="flex items-center p-4 bg-gray-700 border-2 border-gray-600 rounded-lg cursor-pointer hover:bg-gray-650 transition"
                                   :class="locationType === 'hybrid' ? 'border-blue-500 bg-gray-650' : ''">
                                <input type="radio" name="location_type" value="hybrid" x-model="locationType" required class="mr-3">
                    ...
                    <div x-show="locationType === 'venue' || locationType === 'hybrid'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="venue_name" id="venue_name" value="{{ old('venue_name') }}"
                                   class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    ...
                    <div x-show="locationType === 'online' || locationType === 'hybrid'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="online_platform" id="online_platform" value="{{ old('online_platform') }}"
                                   class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        ...
                        <div>
                            ...
                            <input type="url" name="online_link" id="online_link" value="{{ old('online_link') }}"
                                   class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                   placeholder="https://...">
                            @error('online_link')
                                <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
            ...
            <div x-show="isExternal" class="mb-8 p-6 bg-blue-900/20 border-2 border-blue-600 rounded-xl">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" name="external_ticket_url" id="external_ticket_url" value="{{ old('external_ticket_url') }}"
                               class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    ...
                    <div>
                        ...
                        <input type="text" name="external_ussd_code" id="external_ussd_code" value="{{ old('external_ussd_code') }}"
                               class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    ...
                    <div>
                        ...
                        <input type="text" name="external_reservation_phone" id="external_reservation_phone" value="{{ old('external_reservation_phone') }}"
                               class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    ...
                    <div>
                        ...
                        <textarea name="external_description" id="external_description" rows="3"
                                  class="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                                  placeholder="Any additional information about the external ticketing">{{ old('external_description') }}</textarea>
