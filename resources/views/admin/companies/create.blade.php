...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-2xl border-4 border-indigo-100 overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
            <h3 class="text-2xl font-bold text-white">Add New Company</h3>
            <p class="text-indigo-100 text-sm mt-1">Create a new company account</p>
        </div>

        <form method="POST" action="{{ route('admin.companies.store') }}" class="p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">{{ old('description') }}</textarea>
