...
<div class="max-w-md w-full space-y-8">
    <div class="text-center">
        ...
        <p class="mt-1 text-center text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600 dark:from-cyan-400 dark:to-blue-400">
            Associate yourself with the trybe 🚀
        </p>
    </div>
    ...
    <div x-data="{
        ...
        <div class="flex gap-2">
            <button type="button"
                    ...
                    :class="loginMethod === 'email' ? 'bg-gradient-to-r from-cyan-600 to-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
            ...
            <button type="button"
                    ...
                    :class="loginMethod === 'phone' ? 'bg-gradient-to-r from-cyan-600 to-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                    class="flex-1 px-4 py-2 rounded-lg font-medium transition-all">
                <svg class="w-5 h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form x-show="loginMethod === 'email'" class="space-y-6" action="{{ route('organization.login') }}" method="POST">
        @csrf
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
                <a href="{{ route('organization.password.request') }}" class="font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
                    Forgot password?
                </a>
            </div>
        </div>
        ...
        <div class="text-center space-y-2">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
                Just exploring events?
                <a href="{{ route('user.login') }}" class="font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300">
                    Sign in as Attendee
                </a>
            </p>
    ...
    <form x-show="loginMethod === 'phone'" class="space-y-6"
        ...
        <div x-show="otpSent" x-cloak class="text-center">
            <a href="{{ route('organization.login') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400">
