                    ...
                    @foreach($plans as $plan)
                        <div class="relative bg-white rounded-2xl shadow-xl border-2 border-gray-200 hover:border-indigo-300 hover:shadow-2xl transition-all duration-200 overflow-hidden group">
                            ...
                            <div class="p-6">
                                ...
                                <form method="POST" action="{{ route('organization.sms.wallet.purchase') }}">
                                    @csrf
                                ...
                                @foreach($transactions as $transaction)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap text-sm">
                                            <a href="{{ route('organization.sms.transactions.show', $transaction->id) }}" class="text-indigo-600 hover:text-indigo-900 font-semibold">
                                                View Details
                                            </a>
                                        </td>
                                    </tr>
