...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Send an SMS to a single recipient</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border-2 border-indigo-100 overflow-hidden">
            ...
            <form method="POST" action="{{ route('organization.sms.campaigns.send-single.store') }}" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="e.g., 0241234567 or 0241234567, 0551234567, 0201234567"
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-indigo-600 font-semibold">
                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <strong>Tip:</strong> Send to multiple recipients by separating numbers with commas
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="sender_id" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                        ...
                        @foreach($senderIds as $senderId)
                            <option value="{{ $senderId->sender_id }}" {{ old('sender_id') === $senderId->sender_id ? 'selected' : '' }}>
                                {{ $senderId->sender_id }}
