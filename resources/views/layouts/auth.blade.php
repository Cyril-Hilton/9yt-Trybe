...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative overflow-x-hidden">
    ...
    <div class="fixed inset-0 z-0 pointer-events-none">
        <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-purple-400/20 dark:bg-purple-900/20 blur-[100px] animate-pulse"></div>
            ...
            <div class="flex justify-between items-center h-16 sm:h-20">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('home') }}" class="flex items-center logo-hover">
                        <img x-show="!darkMode" src="{{ asset('ui/logo/9yt-trybe-logo-light.png') }}" alt="9yt !Trybe Logo" class="h-8 sm:h-10 md:h-12 w-auto transition-all">
                        <img x-show="darkMode" x-cloak src="{{ asset('ui/logo/9yt-trybe-logo-dark.png') }}" alt="9yt !Trybe Logo" class="h-8 sm:h-10 md:h-12 w-auto transition-all">
                    </a>
                </div>
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    <!-- Back to Home Button -->
                    <a href="{{ route('home') }}" class="hidden sm:inline-flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-gray-100/50 dark:hover:bg-gray-800/50 rounded-lg transition-all flex-shrink-0">
                    ...
                    <!-- Mobile: Icon Only -->
                    <a href="{{ route('home') }}" class="sm:hidden p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition flex-shrink-0">
                    ...
                    <!-- Dark Mode Toggle -->
                    <button @click="darkMode = !darkMode" class="p-2 rounded-lg bg-gray-100/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition flex-shrink-0 shadow-sm ring-1 ring-gray-900/5 dark:ring-white/10">
                        <svg x-show="!darkMode" class="w-5 h-5 sm:w-6 sm:h-6 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/>
                        </svg>
                        <svg x-show="darkMode" x-cloak class="w-5 h-5 sm:w-6 sm:h-6 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Main Content Area -->
    <main class="min-h-screen relative z-10 pt-24 pb-12 sm:pt-28 sm:pb-16 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        @yield('content')
    </main>
